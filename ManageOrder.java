...
public class ManageOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(548, 6, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Customer List");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(144, 68, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 108, 410, 216));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setText("Product List");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(604, 68, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 108, 456, 216));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setText("Cart");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 68, -1, -1));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(896, 108, -1, 216));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 404, -1, -1));

        txtCustomerName.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtCustomerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 427, 401, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText("Mobile Number");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 480, -1, -1));

        txtCustomerMobileNumber.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtCustomerMobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 503, 401, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Email");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 560, -1, -1));

        txtCustomerEmail.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtCustomerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 583, 401, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setText("Selected Product");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(447, 362, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setText("Product Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 402, -1, -1));

        txtProductName.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProductName, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 425, 433, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("Product Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 478, -1, -1));

        txtProductPrice.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProductPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 501, 433, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setText("Product Description");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 565, -1, -1));

        txtProductDescription.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProductDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 588, 433, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setText("Order Quantity");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 641, -1, -1));

        txtOrderQuantity.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtOrderQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 664, 433, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 710, -1, -1));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel14.setText("Total Amount RS: ");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(993, 362, -1, -1));

        btnSaveOrderDetails.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        getContentPane().add(btnSaveOrderDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 425, 196, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 504, 196, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 582, 196, -1));

        lblFinalTotalPrice.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblFinalTotalPrice.setText("00000");
        getContentPane().add(lblFinalTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 350, 80, 50));
    ...
    private void btnSaveOrderDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveOrderDetailsActionPerformed
        // TODO add your handling code here:                                                           
    // Validate if a customer is selected and if products are in the cart
    if (finalTotalPrice != 0 && !txtCustomerName.getText().trim().equals("") && coustomerPk != 0) {
        String orderId = getUniqueld("Bill-"); // Make sure orderId is unique
        ...
        if (tableCart.getRowCount() != 0) {
            for (int i = 0; i < tableCart.getRowCount(); i++) {
                try {
                    ...
                    int productId = Integer.parseInt(tableCart.getValueAt(i, 0).toString());
                    int quantity = Integer.parseInt(tableCart.getValueAt(i, 2).toString());
                    st.executeUpdate("UPDATE product SET quantity = quantity - " + quantity + " WHERE product_pk = " + productId);
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, e);
                }
            }
        ...
        try {
            ...
            try {
                ...
                projectName.setAlignment(com.itextpdf.text.Element.ALIGN_CENTER);
                doc.add(projectName);

                // Order Info
                Paragraph orderDetails = new Paragraph("Order ID: " + orderId + "\nDate: " + myFormat.format(cal.getTime()) + "\n");
                ...
                // Total Amount
                Paragraph totalAmount = new Paragraph("Total Amount RS: " + finalTotalPrice);
                totalAmount.setAlignment(com.itextpdf.text.Element.ALIGN_RIGHT);
                doc.add(totalAmount);
            ...
            // Open the PDF using your OpenPdf utility
            OpenPdf.openById(orderId);

            // Refreshing the screen after saving the order
            setVisible(false);
        ...
        // Validation error if customer is not selected or cart is empty
        JOptionPane.showMessageDialog(null, "Please add some products to the cart and select a customer.");
    }
    ...
    private void tableCustomerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCustomerMouseClicked
        ...
        coustomerPk = Integer.parseInt(id);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!noofunits.equals("")) {
            ...
            int checkStock = 0;
            int checkProductAlreadyExisInCart = 0;
            ...
            // If the product is in stock, check if it is already in the cart
            if (checkStock == 1) {
                ...
                for (int i = 0; i < tableCart.getRowCount(); i++) {
                    if (Integer.parseInt(model.getValueAt(i, 0).toString()) == productPk) {
                        checkProductAlreadyExisInCart = 1;
                ...
                if (checkProductAlreadyExisInCart == 0) {
            ...
            clearProductFields(); // Clear the fields after adding the product
        } else {
            JOptionPane.showMessageDialog(null, "No quantity or product selected.");
        }
